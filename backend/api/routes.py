...
def ml_status():
  ...
  return {
    "model_exists": exists,
    "message":  "Model ready" if exists else "Not trained yet. POST /api/ml/train first.",
  }
...
async def start_bot(paper: bool = True):
  """
  Mulai bot trading.
  - ?paper=true  → paper trading / simulasi (default, recommended)
  - ?paper=false → live trading (pastikan paper trading profitable dulu!)
  """
  from backend.services.bot_engine import bot
